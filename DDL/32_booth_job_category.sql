DROP TABLE IF EXISTS `booth_job_category`;
CREATE TABLE `booth_job_category`
(
    ...
    CONSTRAINT `registration_job_category_registration_job_fk` FOREIGN KEY (`registration_job_position_id`) REFERENCES `booth_job_position` (`id`),
