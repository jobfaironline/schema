DROP TABLE IF EXISTS `booth_job_skill_tag`;
CREATE TABLE `booth_job_skill_tag`
(
    ...
    CONSTRAINT `registration_job_skill_tag_registration_job_fk` FOREIGN KEY (`registration_job_position_id`) REFERENCES `booth_job_position` (`id`),
